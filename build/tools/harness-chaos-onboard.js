...
export function registerOnboardTool(server, client, config) {
    server.registerTool("harness_chaos_onboard", {
        description: "Automate Kubernetes chaos engineering onboarding. Lists available delegates, " +
        ...
        inputSchema: z.object({
            output_dir: z
                .string()
                .describe("Directory path where Terraform files will be written (e.g. './chaos-onboarding-tf'). Created if it doesn't exist.")
                .default("./chaos-onboarding-tf"),
            delegate_selectors: z
                .array(z.string())
                .describe("Delegate selectors (tags) to use for the Kubernetes connector. " +
        ...
        try {
            ...
            if (!args.delegate_selectors || args.delegate_selectors.length === 0) {
                ...
                if (delegates.length === 0) {
                    return jsonResult({
                        ...
                        next_step: "Install a Harness Delegate, then call harness_chaos_onboard again " +
                ...
                return jsonResult({
                    ...
                    next_step: "Ask the user to choose a delegate from the list above, " +
                        "then call harness_chaos_onboard with delegate_selectors=[\"<chosen_delegate_name>\"].",
                    example_call: 'harness_chaos_onboard(delegate_selectors=["<delegate_name>"], output_dir="./chaos-onboarding-tf")',
                });
            }
            ...
            const tfvars = generateTfvarsTemplate(config.HARNESS_ACCOUNT_ID, args.delegate_selectors);
