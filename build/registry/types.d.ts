...
export type ToolsetName = "chaos";
export type OperationName = "list" | "get" | "create" | "update" | "delete" | "execute";
/**
 * Lightweight field descriptor for body schemas.
 * Pure data (not Zod) — serializable to JSON for harness_chaos_describe output.
 */
...
export interface EndpointSpec {
    method: HttpMethod;
    /** Path template, e.g. "/gateway/chaos/manager/api/rest/v2/experiment/{identity}" */
    path: string;
    ...
    /** Description shown in harness_chaos_describe output */
    description?: string;
    /** Optional body schema for write operations — exposed via harness_chaos_describe */
...
export interface ResourceDefinition {
    /** Unique key: "chaos_experiment", "chaos_hub", etc. */
    resourceType: string;
    /** Human-readable name: "Chaos Experiment", "Chaos Hub", etc. */
    displayName: string;
    /** Brief description for harness_chaos_describe output */
    description: string;
    ...
    /** Primary identifier field names: ["experiment_id"], ["hub_id"], etc. */
