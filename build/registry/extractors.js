 ...
 */
export const chaosListExtract = (raw) => {
 ...
 */
export const chaosExperimentListExtract = (raw) => {
 ...
 */
export const chaosExperimentRunListExtract = (raw) => {
    const result = chaosListExtract(raw);
    const items = result.items.map((item) => {
        if (!isRecord(item))
            return item;
 ...
 */
export const chaosHubListExtract = (raw) => {
    const result = chaosListExtract(raw);
    const items = result.items.map((item) => {
        if (!isRecord(item))
            return item;
 ...
 */
export const chaosInfraListExtract = (raw) => {
    const result = chaosListExtract(raw);
    const items = result.items.map((item) => {
        if (!isRecord(item))
            return item;
 ...
 */
export const chaosProbeListExtract = (raw) => {
    const result = chaosListExtract(raw);
    const items = result.items.map((item) => {
        if (!isRecord(item))
            return item;
 ...
 */
export const chaosFaultListExtract = (raw) => {
    const result = chaosListExtract(raw);
    const items = result.items.map((item) => {
        if (!isRecord(item))
            return item;
 ...
 */
export const chaosGuardConditionListExtract = (raw) => {
    const result = chaosListExtract(raw);
    const items = result.items.map((item) => {
        if (!isRecord(item))
            return item;
 ...
 */
export const chaosGuardRuleListExtract = (raw) => {
    const result = chaosListExtract(raw);
    const items = result.items.map((item) => {
        if (!isRecord(item))
            return item;
 ...
 */
export const chaosNetworkMapListExtract = (raw) => {
    const result = chaosListExtract(raw);
    const items = result.items.map((item) => {
        if (!isRecord(item))
            return item;
 ...
 */
export const chaosExperimentStatsExtract = (raw) => {
    if (!isRecord(raw))
        return raw;
 ...
 */
export const chaosRecommendationListExtract = (raw) => {
    const result = chaosListExtract(raw);
    const items = result.items.map((item) => {
        if (!isRecord(item))
            return item;
 ...
 */
export const chaosRiskExtract = (raw) => {
    if (!isRecord(raw))
        return raw;
    const data = isRecord(raw.data) ? raw.data : raw;
    return data;
 ...
 */
export const chaosDrTestListExtract = (raw) => {
    const result = chaosListExtract(raw);
    const items = result.items.map((item) => {
        if (!isRecord(item))
            return item;
 ...
 */
export const chaosActionListExtract = (raw) => {
    const result = chaosListExtract(raw);
    const items = result.items.map((item) => {
        if (!isRecord(item))
            return item;
